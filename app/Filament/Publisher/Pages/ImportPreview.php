...
class ImportPreview extends Page
{
    ...
    protected static string  $view = 'filament.publisher.pages.import-preview';
    ...
    public function mount(): void
    {
        ...
        // Security: chỉ owner đang active mới xem được
        if ($session['owner_id'] !== (string) auth()->user()->current_owner_id) {
            abort(403);
        }
    ...
    public function confirmImport(ScreenRegistryService $registry): void
    {
        ...
        $this->redirect('/publisher/tools/import/confirm?token=' . $this->token, navigate: true);
    }
