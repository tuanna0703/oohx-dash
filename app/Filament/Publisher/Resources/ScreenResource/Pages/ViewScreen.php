        ...
        return $infolist->schema([
            ...
            Infolists\Components\Section::make('Summary')->columns(4)->schema([
                ...
                Infolists\Components\TextEntry::make('internal_notes')
                    ->label('Internal notes')->placeholder('—')->columnSpan(1),
            ...
            Infolists\Components\Section::make('Site & location')->columns(3)->schema([
                ...
                Infolists\Components\TextEntry::make('inventory.network.name')
            ...
            Infolists\Components\Section::make('Inventory & commercial')->columns(3)->schema([
                ...
                Infolists\Components\TextEntry::make('screen_count_override')
                ...
                Infolists\Components\TextEntry::make('selective_listing')
            ...
            Infolists\Components\Section::make('Playback')->columns(3)->schema([
                ...
                Infolists\Components\TextEntry::make('spot_length')
                ...
                Infolists\Components\TextEntry::make('loop_length')
                    ->label('Loop length')
